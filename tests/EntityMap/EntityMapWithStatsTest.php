...
class EntityMapWithStatsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_it_allows_to_add_many_entities_with_unique_index_if_indexed_property_is_null()
    {
        $map = new EntityMapWithStats([
            'unique' => [
                ['name'],
        ...
        $foundOne = $map->findOneEntity(['name' => 'ala']);
        self::assertSame($entityOne, $foundOne);
        
        $foundTwo = $map->findOneEntity(['age' => 15, 'symbol' => 'z']);
        self::assertSame($entityThree, $foundTwo);
